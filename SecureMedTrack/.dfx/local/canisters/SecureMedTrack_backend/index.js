...
import { idlFactory } from './SecureMedTrack_backend.did.js';
export { idlFactory } from './SecureMedTrack_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SECUREMEDTRACK_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./SecureMedTrack_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the SecureMedTrack_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./SecureMedTrack_backend.did.js")._SERVICE>}
 */
export const SecureMedTrack_backend = createActor(canisterId);
