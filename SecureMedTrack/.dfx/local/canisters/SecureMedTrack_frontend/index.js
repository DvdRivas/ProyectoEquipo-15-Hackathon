...
import { idlFactory } from './SecureMedTrack_frontend.did.js';
export { idlFactory } from './SecureMedTrack_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SECUREMEDTRACK_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./SecureMedTrack_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the SecureMedTrack_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./SecureMedTrack_frontend.did.js")._SERVICE>}
 */
export const SecureMedTrack_frontend = createActor(canisterId);
