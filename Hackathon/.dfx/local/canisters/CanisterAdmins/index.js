...
import { idlFactory } from './CanisterAdmins.did.js';
export { idlFactory } from './CanisterAdmins.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CANISTERADMINS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./CanisterAdmins.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the CanisterAdmins canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./CanisterAdmins.did.js")._SERVICE>}
 */
export const CanisterAdmins = createActor(canisterId);
