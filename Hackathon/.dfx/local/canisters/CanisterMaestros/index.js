...
import { idlFactory } from './CanisterMaestros.did.js';
export { idlFactory } from './CanisterMaestros.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CANISTERMAESTROS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./CanisterMaestros.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the CanisterMaestros canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./CanisterMaestros.did.js")._SERVICE>}
 */
export const CanisterMaestros = createActor(canisterId);
