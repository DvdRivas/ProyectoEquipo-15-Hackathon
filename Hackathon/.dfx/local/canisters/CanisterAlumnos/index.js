...
import { idlFactory } from './CanisterAlumnos.did.js';
export { idlFactory } from './CanisterAlumnos.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CANISTERALUMNOS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./CanisterAlumnos.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the CanisterAlumnos canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./CanisterAlumnos.did.js")._SERVICE>}
 */
export const CanisterAlumnos = createActor(canisterId);
