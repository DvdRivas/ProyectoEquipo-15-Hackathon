...
module Funciones {
    ...
    public func ObtenerNombre(matricula: Text, alumnos:Map.Map<Text, Types.Alumno>): ?Text {
    switch (Map.get(alumnos, thash, matricula)) {
        case (?alumno) { return ?alumno.nombreCompleto };
